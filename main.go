...
func main() {
	...
	app.Action = func(c *cli.Context) error {
		...
		analyzer := CreateAnalyzer(mainAsset, exchange.GetCharge(), threshold)
...
func CreateAnalyzer(mainAsset models.Asset, charge float64, threshold float64) usecase.MarketAnalyzer {
